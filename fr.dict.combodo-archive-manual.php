...
Dict::Add('FR FR', 'French', 'Français', array(
	...
	'Class:ArchivingRule/Error:StatusCodeNotValid' => 'Le "Code du statut avant archivage" doit être un attribut de type énum pour la classe "%1$s".  "%2$s" n\'est pas un énum',
