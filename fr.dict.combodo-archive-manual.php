...
Dict::Add('FR FR', 'French', 'Français', array(
	...
	'Class:ArchivingRule/Attribute:pre_archiving_status_code+' => 'Choisir l\'attribut à tester sur les objets de la classe choisie pour que la règle leur soit appliquée' ,
	...
	'Class:ArchivingRule/Error:AttributeMustBeDate' =>'La "%3$s" doit être un attribut de type date pour la classe "%1$s".  "%2$s" n\'est pas une date',
	'Class:ArchivingRule/Error:StatusNotValid' => '"%2$s" n\'est pas un attribut valide pour la classe  "%1$s"',
	'Class:ArchivingRule/Error:StatusCodeNotValid' => 'Le "%3$s" doit être un attribut de type énum pour la classe "%1$s".  "%2$s" n\'est pas un énum',
